function exportRootInterface(dbus, params) {
  ...
  dbus.exportInterface({
    ...
    // DEV: Not too sure how this worked but took a guess based off of
    //   https://github.com/sidorares/node-dbus/issues/79
    SupportedUriSchemes: rootParams.SupportedUriSchemes || [['wat']], // Read only
    SupportedMimeTypes: rootParams.SupportedMimeTypes || [['huh']] // Read only
