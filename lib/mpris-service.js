...
var exportRootInterface = require('./root-interface');
...
function MprisService(params) {
  ...
  exportRootInterface(this.dbus, params.Root);
  ...
  this._exportTrackListInterface(params.TrackList);
  this._exportPlaylistsInterface(params.Playlists);
}
